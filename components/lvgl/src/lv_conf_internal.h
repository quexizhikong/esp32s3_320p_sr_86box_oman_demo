...
//            #define LV_MEM_CUSTOM_ALLOC   malloc
            #define LV_MEM_CUSTOM_ALLOC(size) heap_caps_malloc(size,MALLOC_CAP_8BIT|MALLOC_CAP_SPIRAM)//ָ��ʹ���ⲿpsram
        #endif
    #endif
...
//            #define LV_MEM_CUSTOM_REALLOC realloc
            #define LV_MEM_CUSTOM_REALLOC(ptr,size) heap_caps_realloc(ptr, size, MALLOC_CAP_8BIT|MALLOC_CAP_SPIRAM)//ָ��ʹ���ⲿpsram
        #endif
    #endif
#endif     /*LV_MEM_CUSTOM*/
